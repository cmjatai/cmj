...
def test_lista_protocolos_duplicados():
    mommy.make(Protocolo, numero=15, ano=2031)
    mommy.make(Protocolo, numero=15, ano=2031)
    mommy.make(Protocolo, numero=33, ano=2033)
...
def test_lista_protocolos_com_materias():
    mommy.make(Protocolo, numero=15, ano=2035)
    mommy.make(Protocolo, numero=33, ano=2035)

    tipo_materia = mommy.make(TipoMateriaLegislativa, descricao="Tipo_Materia_Teste")
...
def test_lista_materias_protocolo_inexistente():
    protocolo_a = mommy.make(Protocolo, numero=15, ano=2031)
...
def test_lista_mandatos_sem_data_inicio():
    ...
    mandato_a = mommy.make(Mandato, parlamentar=parlamentar, legislatura=legislatura)
    mommy.make(
        Mandato,
...
def test_lista_parlamentares_filiacoes_intersecao():
    partido = mommy.make(Partido, sigla="ST", nome="Nome_Partido_Teste")
    parlamentar_a = mommy.make(
        Parlamentar,
        nome_completo="Nome_Completo_Parlamentar_Teste",
        nome_parlamentar="Nome_Parlamentar_Teste",
    ...
    mommy.make(Filiacao, parlamentar=parlamentar_b, partido=partido, data="2018-02-28")
...
def test_lista_autores_duplicados():
    tipo_autor = mommy.make(TipoAutor, descricao="Tipo_Autor_Teste")

    mommy.make(Autor, tipo=tipo_autor, nome="Nome_Autor_Teste")
    mommy.make(Autor, tipo=tipo_autor, nome="Nome_Autor_Teste")
    mommy.make(Autor, tipo=tipo_autor, nome="Nome_Autor_Teste-1")
...
def test_lista_bancada_comissao_autor_externo():
    tipo_autor = mommy.make(TipoAutor, descricao="Tipo_Autor_Teste")
    tipo_autor_externo = mommy.make(TipoAutor, descricao="Externo")
