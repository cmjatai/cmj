...
from .views import (
    ...
    RelatorioAtasView,
    RelatorioAudienciaView,
    RelatorioDataFimPrazoTramitacaoView,
    RelatorioDocumentosAcessoriosView,
...
admin_user = [
    ...
    re_path(
        r"^sistema/usuario/create$", CreateUsuarioView.as_view(), name="user_create"
    ),
    re_path(
        r"^sistema/usuario/(?P<pk>\d+)/edit$",
        EditUsuarioView.as_view(),
        name="user_edit",
    ),
    re_path(
        r"^sistema/usuario/(?P<pk>\d+)/delete$",
        DeleteUsuarioView.as_view(),
        name="user_delete",
    ),
]
...
urlpatterns = [
    ...
    re_path(
        r"^sistema/ajuda/(?P<topic>\w+)$", HelpTopicView.as_view(), name="help_topic"
    ),
    re_path(
        r"^sistema/ajuda/$",
    ...
    re_path(
        r"^sistema/relatorios/relatorio-por-mes$",
        RelatorioNormasPublicadasMesView.as_view(),
        name="normas_por_mes",
    ),
    re_path(
        r"^sistema/relatorios/relatorio-por-vigencia$",
        RelatorioNormasVigenciaView.as_view(),
        name="normas_por_vigencia",
    ),
    re_path(
        r"^sistema/relatorios/estatisticas-acesso$",
        EstatisticasAcessoNormas.as_view(),
        name="estatisticas_acesso",
    ),
    re_path(
        r"^sistema/relatorios/materia-por-ano-autor-tipo$",
        RelatorioMateriasPorAnoAutorTipoView.as_view(),
        name="materia_por_ano_autor_tipo",
    ),
    re_path(
        r"^sistema/relatorios/materia-por-tramitacao$",
        RelatorioMateriasTramitacaoView.as_view(),
        name="materia_por_tramitacao",
    ),
    re_path(
        r"^sistema/relatorios/historico-tramitacoes$",
    ...
    re_path(
        r"^sistema/relatorios/reuniao$", RelatorioReuniaoView.as_view(), name="reuniao"
    ),
    re_path(
        r"^sistema/relatorios/audiencia$",
        RelatorioAudienciaView.as_view(),
        name="audiencia",
    ),
    re_path(
        r"^sistema/relatorios/historico-tramitacoesadm$",
        RelatorioHistoricoTramitacaoAdmView.as_view(),
        name="historico_tramitacoes_adm",
    ),
    re_path(
        r"^sistema/relatorios/documentos_acessorios$",
        RelatorioDocumentosAcessoriosView.as_view(),
        name="relatorio_documentos_acessorios",
    ),
    re_path(
        r"^sistema/relatorios/normas-por-autor$",
        RelatorioNormasPorAutorView.as_view(),
        name="normas_por_autor",
    ),
    re_path(
