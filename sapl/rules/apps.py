...
@receiver(
    post_migrate, dispatch_uid="django.contrib.auth.management.create_permissions"
)
    ...
    for klass in list(app_config.get_models()):
        ...
        permissions = (
            (
                ...
                format_lazy(
                    "{} {}", _("Visualizaçao da lista de"), opts.verbose_name_plural
                ),
            ),
            (
        ...
        with connection.cursor() as cursor:
            ...
            if rows[0][0] is None:
                ...
                create_sequence = ("""
                    ...
                    """ + query) % {"table_name": model._meta.db_table}
...
def signal_check_ids_sequences(
    app_config, verbosity=2, interactive=True, using=DEFAULT_DB_ALIAS, **kwargs
):
