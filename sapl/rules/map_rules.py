...
rules_group_protocolo = {
    ...
    "rules": [
        ...
        (
            ...
            set(),
        ),  # TODO: tratar em sapl.api questão de que proposições incorporadas serem públicas
        (
...
rules_group_norma = {
    ...
    "rules": [
        ...
        (compilacao.TextoArticulado, __base__ + ["lock_textoarticulado"], set()),
    ],
}
...
rules_group_parlamentar = {"group": SAPL_GROUP_PARLAMENTAR, "rules": []}

rules_group_votante = {
    "group": SAPL_GROUP_VOTANTE,
    "rules": [(parlamentares.Votante, ["can_vote"], set())],
}
...
rules_group_geral = {
    ...
    "rules": [
        ...
        (materia.AssuntoMateria, __base__, __perms_publicas__),  # não há implementação
        (materia.MateriaAssunto, __base__, __perms_publicas__),  # não há implementação
        (materia.MateriaLegislativa, ["can_access_impressos"], __perms_publicas__),
        ...
        (
            compilacao.TextoArticulado,
            __base__ + ["unlock_textoarticulado", "lock_textoarticulado"],
            set(),
        ),
