...
from sapl.materia.views import (
    ...
    AnaliseSimilaridadeCrud,
    AnaliseSimilaridadeRankingCrud,
    AnexadaCrud,
    AssuntoMateriaCrud,
    AutoriaCrud,
...
urlpatterns_impressos = [
    re_path(r"^materia/impressos/$", ImpressosView.as_view(), name="impressos"),
    re_path(
...
urlpatterns_materia = [
    ...
    re_path(r"^materia/dash", MateriaDashboardView.as_view(), name="materia_dashboard"),
    re_path(
        r"^materia/similaridades", include(AnaliseSimilaridadeRankingCrud.get_urls())
    ),
    re_path(
    ...
    re_path(
        r"^materia/(?P<pk>[0-9]+)/create_doc_acess$",
    ...
    re_path(r"^materia/(?P<pk>[0-9]+)/ta$", MateriaTaView.as_view(), name="materia_ta"),
    re_path(
        r"^materia/check$", MateriaLegislativaCheckView.as_view(), name="materia_check"
    ),
    re_path(
...
urlpatterns_proposicao = [
    ...
    re_path(r"^sistema/proposicao/tipo", include(TipoProposicaoCrud.get_urls())),
    re_path(
...
urlpatterns_sistema = [
    re_path(r"^sistema/assunto-materia", include(AssuntoMateriaCrud.get_urls())),
    re_path(r"^sistema/proposicao/tipo", include(TipoProposicaoCrud.get_urls())),
    ...
    re_path(r"^sistema/materia/tipo-documento", include(TipoDocumentoCrud.get_urls())),
    re_path(
        r"^sistema/materia/tipo-fim-relatoria", include(TipoFimRelatoriaCrud.get_urls())
    ),
    re_path(
