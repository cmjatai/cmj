...
def test_incluir_norma_submit(admin_client):
    ...
    tipo = mommy.make(TipoNormaJuridica, sigla="T", descricao="Teste")
...
def test_norma_juridica_materia_existente():
    ...
    mommy.make(MateriaLegislativa, numero=2, ano=2017, tipo=tipo_materia)
