...
class NormaFilterSet(django_filters.FilterSet):
    ...
    apelido = django_filters.CharFilter(lookup_expr="icontains", label=_("Apelido"))
        ...
        if self.instance.numero != cleaned_data["numero"]:
            ...
            if norma:
                ...
                raise ValidationError(
                    "Já existe uma norma de mesmo Tipo, Ano " "e Número no sistema"
                )
        if (
...
class NormaRelacionadaForm(ModelForm):
    ...
    def clean(self):
        ...
        try:
            self.logger.debug(
                "Tentando obter objeto NormaJuridica com numero={}, ano={}, tipo={}.".format(
            ...
            self.logger.info(
                "NormaJuridica com numero={}, ano={}, tipo={} não existe.".format(
                    cleaned_data["numero"], cleaned_data["ano"], cleaned_data["tipo"]
                )
            )
            ...
            self.logger.info(
                "NormaJuridica com numero={}, ano={}, tipo={} obtida com sucesso.".format(
                    cleaned_data["numero"], cleaned_data["ano"], cleaned_data["tipo"]
                )
            )
