...
def materias(lst_materias):
    ...
    for dic in lst_materias:
        ...
        if dic["materia"] != None:
            ...
            tmp_data += "\t\t</para>\n"
            tmp_data += (
                '\t\t<para style="P2"><b>INDICAÇÃO:</b> ' + dic["materia"] + "</para>\n"
            )
            tmp_data += '\t\t<para style="P2">\n'
            tmp_data += '\t\t\t<font color="white"> </font>\n'
            tmp_data += "\t\t</para>\n"
        ...
        if dic["dat_apresentacao"] != None:
            tmp_data += (
                '\t\t<para style="P2"><b>DATA DE ENTRADA:</b> '
        ...
        if dic["txt_ementa"] != None:
            ...
            tmp_data += (
                '\t\t<para style="P2"><b>EMENTA:</b> ' + dic["txt_ementa"] + "</para>\n"
            )
            tmp_data += '\t\t<para style="P2">\n'
            tmp_data += '\t\t\t<font color="white"> </font>\n'
            tmp_data += "\t\t</para>\n"
...
def principal(imagem, lst_materias, dic_cabecalho, lst_rodape):
    ...
    tmp_data += "\t\t\t</pageGraphics>\n"
    tmp_data += (
        '\t\t\t<frame id="first" x1="2cm" y1="4cm" width="17cm" height="21cm"/>\n'
    )
