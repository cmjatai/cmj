...
from sapl.utils import parseString, xstr
...
def protocolos(lst_protocolos):
    ...
    for dic in lst_protocolos:
        ...
        # protocolos
        tmp_data += (
            '\t\t<barCode code="Code128" x="5.6cm" barHeight="0.3in" barWidth="0.012in">'
            + dic["titulo"]
            + "</barCode>\n"
        )
        tmp_data += (
            '\t\t<para style="P2"><b>Protocolo:</b> ' + dic["titulo"] + "</para>\n"
        )
        ...
        tmp_data += (
            '\t\t<para style="P1"><b>Autor:</b> <font size="8">'
            + dic["nom_autor"]
            + "</font></para>\n"
        )
        ...
        tmp_data += "\t\t</para>\n"
        tmp_data += (
            '\t\t<para style="P3"><b>Ementa:</b> <font size="8">'
...
def principal(imagem, lst_protocolos, dic_cabecalho, lst_rodape):
    ...
    tmp_data += "\t\t</pageGraphics>\n"
    tmp_data += (
        '\t\t\t<frame id="first" x1="4mm" y1="1mm" width="94mm" height="60mm"/>\n'
    )
