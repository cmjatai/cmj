...
urlpatterns = [
    re_path(
        ...
        include(
            ...
            + AfastamentoParlamentarCrud.get_urls()
            + BancadaCrud.get_urls()
        ),
    ),
    re_path(r"^parlamentar/bancada", include(BancadaCrud.get_urls())),
    re_path(r"^parlamentar/bloco", include(BlocoCrud.get_urls())),
    ...
    re_path(
        r"^parlamentar/deleta_partido/(?P<pk>\d+)/$",
        deleta_historico_partido,
        name="deleta_historico_partido",
    ),
    re_path(
        r"^parlamentar/(?P<pk>\d+)/materias$",
        ParlamentarMateriasView.as_view(),
        name="parlamentar_materias",
    ),
    re_path(
        r"^parlamentar/vincular-parlamentar/$",
    ...
    re_path(r"^sistema/cargo-bancada", include(CargoBancadaCrud.get_urls())),
    re_path(r"^sistema/cargo-bloco", include(CargoBlocoCrud.get_urls())),
    re_path(
        r"^sistema/vincula-parlamentar-ao-bloco/(?P<pk>\d+)/",
        vincula_parlamentar_ao_bloco,
        name="vincula_parlamentar_ao_bloco",
    ),
    re_path(
        r"^sistema/edita-vinculo-parlamentar-bloco/(?P<pk>\d+)/",
        edita_vinculo_parlamentar_bloco,
        name="edita-vinculo-parlamentar-bloco",
    ),
    re_path(
        r"^sistema/deleta-vinculo-parlamentar-bloco/(?P<pk>\d+)/",
        deleta_vinculo_parlamentar_bloco,
        name="deleta-vinculo-parlamentar-bloco",
    ),
    ...
    re_path(r"^sistema/parlamentar/legislatura", include(LegislaturaCrud.get_urls())),
    re_path(
        r"^sistema/parlamentar/tipo-dependente", include(TipoDependenteCrud.get_urls())
    ),
    re_path(
        r"^sistema/parlamentar/nivel-instrucao", include(NivelInstrucaoCrud.get_urls())
    ),
    re_path(
        r"^sistema/parlamentar/tipo-afastamento",
        include(TipoAfastamentoCrud.get_urls()),
    ),
    re_path(r"^sistema/parlamentar/tipo-militar", include(TipoMilitarCrud.get_urls())),
    re_path(r"^sistema/parlamentar/partido", include(PartidoCrud.get_urls())),
    re_path(
        r"^sistema/parlamentar/partido/(?P<pk>\d+)/filiados$",
        parlamentares_filiados,
        name="parlamentares_filiados",
    ),
    re_path(
        r"^sistema/mesa-diretora/sessao-legislativa",
        include(SessaoLegislativaCrud.get_urls()),
    ),
    re_path(r"^sistema/mesa-diretora/cargo-mesa", include(CargoMesaCrud.get_urls())),
    re_path(r"^mesa-diretora/$", MesaDiretoraView.as_view(), name="mesa_diretora"),
    re_path(
        r"^mesa-diretora/altera-field-mesa/$",
        altera_field_mesa,
        name="altera_field_mesa",
    ),
    re_path(
        r"^mesa-diretora/altera-field-mesa-public-view/$",
        altera_field_mesa_public_view,
        name="altera_field_mesa_public_view",
    ),
    re_path(
        r"^mesa-diretora/insere-parlamentar-composicao/$",
        insere_parlamentar_composicao,
        name="insere_parlamentar_composicao",
    ),
    re_path(
        r"^mesa-diretora/remove-parlamentar-composicao/$",
        remove_parlamentar_composicao,
        name="remove_parlamentar_composicao",
    ),
    re_path(
        r"^parlamentar/get-sessoes-legislatura/$",
        get_sessoes_legislatura,
