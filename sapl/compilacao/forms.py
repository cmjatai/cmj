...
class DispositivoEdicaoBasicaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if inst and inst.tipo_dispositivo.formato_variacao0 in [
            ...
            self.dispositivo1 = DispositivoIntegerField(
                label=("1&ordf; %s" % _("Variação")), field_name="dispositivo1"
            )
        ...
        if editor_type == "get_form_base":
            ...
            self.custom_text_link = forms.CharField(
                required=False,
                label="",
            )
            ...
            layout.append(
                Fieldset(
                    _("Texto customizado para o Link de Compilação"),
                    custom_text_link,
                    css_class="col-md-12",
                )
            )
    ...
    def actions_get_form_base(self, layout, inst, texto_articulado_do_editor=None):
        ...
        more = [
            HTML('<a class="btn btn-dark btn-fechar" href="">%s</a>' % cancel_label),
        ]
...
class DispositivoSearchModalForm(Form):
    ...
    texto_articulado_do_editor = forms.CharField(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["texto_articulado_do_editor"].initial = kwargs["initial"][
            "texto_articulado_do_editor"
        ]
...
class DispositivoRegistroAlteracaoForm(Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        more = [
            HTML('<a class="btn btn-dark btn-fechar" href="">%s</a>' % _("Cancelar")),
        ]
        more.append(Submit("salvar", _("Salvar"), css_class="float-right"))
