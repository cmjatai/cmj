...
# pega do comando $1 ou o default
DB_BACKUP_FILE="${1:-backup_BD_PORTAL_CMJ_DEV.backup}"

docker cp "/tmp/${DB_BACKUP_FILE##*/}" stormdb:/tmp/.
...
docker exec stormdb pg_restore  --verbose -U cmj -d cmj "/tmp/${DB_BACKUP_FILE##*/}"
