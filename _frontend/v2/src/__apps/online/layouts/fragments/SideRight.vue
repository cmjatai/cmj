<template>
  <div class="w-100 inner inner-sideright">
    <div class="menu">
      <ul>
        <li>
          <b-img @click="toogleNormaDestaque" src="/static/img/icon_normas_juridicas_destaque.png" fluid rounded="0" />
          <ul class="list-group">
...
<script>
import NormaSimpleModalView from '@/__apps/online/components/norma/NormaSimpleModalView'
