...
urls = [
    {
        "name": "despesa_empenhada_list_exportacao",
        "url": "http://{subdomain}.sigepnet.com.br/transparencia/exportacao/"
        "despesa_empenhada.php?extensao=CSV&orgao={orgao}&ano={ano}&mes={mes}&fornecedor=&cpfcnpj=&acao=true",
        "type": "list",
        "format": "csv",
        ...
        "childs": [
            # {
            #    "name": "despesa_empenhada_detalhes_exportacao",
            #    "url": "http://{subdomain}.sigepnet.com.br/transparencia/exportacao/"
            #    "despesa_empenhada_detalhes.php?extensao=CSV&codigo={codigo}",
            #    "type": "detail",
            #    "format": "csv",
            #    "params": ("codigo",),
            #    "subdomain": ("prefeituradejatai", "camaradejatai"),
            # },
            {
                "name": "despesa_empenhada_detalhes",
                "url": "http://{subdomain}.sigepnet.com.br/transparencia/"
                "despesa_empenhada_detalhes.php?codigoempenho={codigo}",
                "type": "detail",
                "format": "html",
                "params": ("codigo",),
                "subdomain": ("prefeituradejatai", "camaradejatai"),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        order_by = ("-loa__ano", "codigo") if onlychilds else ("codigo", "-loa__ano")
    ...
    def scrap_run_childs(self, scrap, url_childs, params, deep):
        ...
        for idx, row in rows:
            ...
            for url_dict in url_childs:
                ...
                self.scrap_node(
                    url_dict, params=pms, item_list=row, parent=scrap, deep=deep
                )
