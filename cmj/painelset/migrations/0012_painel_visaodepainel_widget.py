...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Nome da Visão no Painel Associado', max_length=256)),
                ...
                ('config', models.JSONField(blank=True, default=dict, encoder=django.core.serializers.json.DjangoJSONEncoder, help_text='Configuração específica da visão neste painel em formato JSON', null=True, verbose_name='Configuração Específica')),
                ('styles', models.JSONField(blank=True, default=dict, encoder=django.core.serializers.json.DjangoJSONEncoder, help_text='Estilos específicos da visão neste painel em formato JSON', null=True, verbose_name='Estilos Específicos')),
                ('painel', models.ForeignKey(help_text='Painel associado', on_delete=django.db.models.deletion.CASCADE, related_name='visao_de_painel_set', to='painelset.painel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='Nome do Widget na Visão Associada', max_length=256)),
                ...
                ('visao', models.ForeignKey(help_text='Visão associada', on_delete=django.db.models.deletion.CASCADE, to='painelset.visaodepainel')),
            ],
            options={
