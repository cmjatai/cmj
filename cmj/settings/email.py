...
EMAIL_HOST_USER = config("EMAIL_HOST_USER", cast=str, default="noreply@jatai.go.leg.br")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", cast=str, default="")
EMAIL_USE_TLS = config("EMAIL_USE_TLS", cast=bool, default=False)
EMAIL_USE_SSL = config("EMAIL_USE_SSL", cast=bool, default=True)
EMAIL_SEND_USER = config(
    "EMAIL_SEND_USER", cast=str, default="Portal CMJ <noreply@jatai.go.leg.br>"
)
