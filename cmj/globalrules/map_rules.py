...
rules_saap_group_workspace_oper_contatos = {
    ...
    "rules": [
        (
            get_user_model(),
            [menu_contatos, menu_dados_auxiliares, menu_relatorios],
            set(),
        ),
...
rules_saap_group_workspace_oper_processos = {
    ...
    "rules": [
        (
            get_user_model(),
            [menu_processos, menu_dados_auxiliares, menu_relatorios],
            set(),
        ),
...
rules_materia_group_workspace = {"group": GROUP_MATERIA_WORKSPACE_VIEWER, "rules": []}


rules_agenda_group_workspace = {
    "group": GROUP_AGENDA_WORKSPACE,
    "rules": [
        (get_user_model(), [menu_dados_auxiliares, menu_agenda], set()),
...
rules_loa_group_operador = {
    ...
    "rules": [
        ...
        (
            loa_models.EmendaLoa,
            __base__ + ["emendaloa_full_editor"],
            __perms_publicas__,
        ),
        ...
        (
            loa_models.EmendaLoaRegistroContabil,
            __base__ + ["emendaloa_full_editor"],
            __perms_publicas__,
        ),
        (
            loa_models.Agrupamento,
            __base__ + ["emendaloa_full_editor"],
            __perms_publicas__,
        ),
        (
            loa_models.AgrupamentoEmendaLoa,
            __base__ + ["emendaloa_full_editor"],
            __perms_publicas__,
        ),
        (
            loa_models.AgrupamentoRegistroContabil,
            __base__ + ["emendaloa_full_editor"],
            __perms_publicas__,
        ),
...
rules_ia_group_operador = {
    ...
    "rules": [
        (search_models.ChatSession, __base__ + ["can_use_chat_module"], set()),
        (search_models.ChatMessage, __base__ + ["can_use_chat_module"], set()),
...
rules_group_anonymous = {"group": GROUP_ANONYMOUS, "rules": []}
...
rules_sigad_view_status_restritos = {
    ...
    "rules": [
        ...
        (sigad_models.Documento, ["view_docume" "nto_show"], set()),
    ],
}
