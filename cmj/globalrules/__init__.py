...
GROUP_SAAP_WORKSPACE_OPER_RECEPCAO = _("Área de Trabalho - Operadores da Recepção")
GROUP_SAAP_WORKSPACE_OPER_CONTATOS = _("Área de Trabalho - Operadores de Contatos")
GROUP_SAAP_WORKSPACE_OPER_PROCESSOS = _("Área de Trabalho - Operadores de Processos")
GROUP_SAAP_WORKSPACE_OPER_GRUPO_CONTATOS = _(
    "Área de Trabalho - Operadores de Grupos de Contatos"
)
GROUP_SAAP_WORKSPACE_MANAGERS = _("Área de Trabalho - Gestores")
...
GROUP_AGENDA_WORKSPACE = _("Área de Trabalho - Agenda - Manutenção da Agenda")
...
PERMS_FOR_USERS = (
    ...
    (menu_impresso_enderecamento, _("Mostrar Menu de Impressos de Endereçamento")),
