...
class Draft(models.Model):
    ...
    def delete(self, using=None, keep_parents=False):
        root_path = Path(
            settings.MEDIA_ROOT, f"cmj/private/draftmidia/{self.owner.id}/{self.id}/"
        )
...
class ArqClasse(Parent):
    ...
    checkcheck = models.BooleanField(verbose_name=_("Arquivado"), default=False)
    ...
    perfil = models.IntegerField(
        _("Perfil da Classe"), choices=PERFIL_ARQCLASSE, default=ARQCLASSE_FISICA
    )
...
class ArqDoc(CommonMixin, Parent, CmjAuditoriaModelMixin):
    ...
    editado = models.BooleanField(verbose_name=_("Editado Manualmente?"), default=False)
