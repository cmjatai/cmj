...
class MateriaSearchView(
    ...
    def get_context(self):
        ...
        if not data:
            ...
            context["view"][
                "tipos_autores_materias"
            ] = (
                self.tipo_autores_materias
            )  # não chamar a função aqui para n fazer query desnecessária
            return context
    ...
    def view_actions(self):
        ...
        return {
            ...
            "create_url": (
                ...
                else reverse("sapl.materia:materialegislativa_create")
            ),
        }
    ...
    def create_response(self):
        ...
        try:
            ...
            return HttpResponseRedirect(reverse("cmj.search:materia_haystack_search"))
...
class NormaSearchView(
    ...
    def urls(self):
        ...
        return {
            ...
            "create_url": (
                ""
                if u.is_anonymous or not u.has_perm("norma.add_normajuridica")
                else reverse("sapl.norma:normajuridica_create")
            ),
        }
