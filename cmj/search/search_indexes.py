...
class NormaJuridicaIndex(BaseIndex, CelerySearchIndex, Indexable):
    ...
    assuntos_is = MultiValueField(model_attr="assuntos__id", null=True)
...
class MateriaLegislativaIndex(BaseIndex, CelerySearchIndex, Indexable):
    ...
    sta_i = IntegerField(model_attr="ultima_tramitacao__status_id", null=True)

    autoria_is = MultiValueField(model_attr="autores__id", null=True)
