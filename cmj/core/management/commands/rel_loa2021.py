...
class Command(BaseCommand):
    ...
    def get_parametros_713(self):
        ...
        coordenadas = {
            ...
            "yf": 474,
            "wf": 121,
            "hf": 95,  # fundo do logotipo
            "xh": 165,
            "yh": 507,
            "wh": 400,
            "hh": 60,  # cabeçalho horizontal
            "xfh": 162,
            "yfh": 500,
            "wfh": 500,
            "hfh": 68,  # fundo do cabeçalho
        }
        arquivos = [
            [
    ...
    def get_parametros_712(self):
        ...
        coordenadas = {
            ...
            "yh": 521,
            "wh": 362,
            "hh": 48,  # cabeçalho horizontal
            "xfh": 205,
            "yfh": 521,
            "wfh": 362,
            "hfh": 48,  # fundo do cabeçalho
        }
        arquivos = [
            [
    ...
    def run_autografo(self, arquivos=None, epigrafe="", partes_ou_completo="C"):
        ...
        def pagina_com_logotipo(v):
            ...
            packet = io.BytesIO()
            try:
                can = canvas.Canvas(packet, pagesize=landscape(A4))  # landscape(A4)
