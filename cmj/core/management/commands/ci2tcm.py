...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.process3(
            f'"{self.folder_raiz}out_ocr_2.pdf"', f'"{self.folder_raiz}out_ocr_3.pdf"'
        )  # executa ocrmypdf no pdf gerado em processo4
    ...
    def criar_pdfs__simone(self, *args, **options):
        ...
        scanners = glob.glob(glob.escape(folder_scanners) + "**", recursive=True)
        scanners.sort()
