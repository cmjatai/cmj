...
from cmj.core.signals_functions import (
    auditlog_signal_function,
    notificacao_signal_function,
    redesocial_post_function,
...
def signal_post_signed_files_extraction(sender, instance, **kwargs):
    signed_files_extraction_post_signal_function(sender, instance, **kwargs)
...
def signal_pre_signed_files_extraction(sender, instance, **kwargs):
    signed_files_extraction_pre_signal_function(sender, instance, **kwargs)
