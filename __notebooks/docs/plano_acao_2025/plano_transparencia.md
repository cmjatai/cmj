...
Plano de Ação Detalhado para Implementação da Cartilha do PNTP na Câmara Municipal de Jataí (Poder Legislativo)
Objetivo Geral:
    • Implementar as diretrizes da Cartilha do PNTP, assegurando a transparência ativa e passiva em todos os níveis da Câmara Municipal de Jataí, conforme as obrigações comuns e as específicas do Poder Legislativo.
Premissas:
    • A implementação será progressiva, priorizando os itens essenciais e obrigatórios.
    • A colaboração e o engajamento de todos os departamentos e servidores são fundamentais.
    • A legislação local (Lei Orgânica Municipal, Regimento Interno etc.) será considerada.
    • Será buscado o aproveitamento máximo de ferramentas e soluções digitais existentes.
    •
Fases do Plano de Ação:
Fase 1: Diagnóstico e Planejamento (Duração: 2 semanas)
    • Atividade: Estudo aprofundado da Cartilha do PNTP, descartando recomendações exclusivas de outros poderes e identificando as obrigações comuns e específicas ao Poder Legislativo.
        ◦ Responsável: Gestor Público
        ◦ Produtos:
            ▪ Lista consolidada das obrigações do Poder Legislativo, com base na Cartilha.
            ▪ Checklist com as lacunas atuais do portal da Câmara, comparando com as exigências da Cartilha.
    • Atividade: Reunião com os chefes de departamento (Administrativo, TI, Jurídico, Comunicação, Finanças, etc.) para apresentar o PNTP e o plano de ação.
        ◦ Responsável: Gestor Público
        ◦ Produtos:
            ▪ Conscientização e engajamento da equipe.
            ▪ Definição de responsabilidades por departamento e cargo.
    • Atividade: Elaboração do cronograma detalhado de implementação, definindo prazos realistas para cada item.
        ◦ Responsável: Gestor Público e Chefes de Departamento
        ◦ Produtos:
            ▪ Cronograma com metas e prazos claros.
Fase 2: Implementação das Obrigações Comuns a Todos os Poderes (Duração: 4 semanas)
    • Atividade: Garantir a existência de um site oficial próprio da Câmara, com visibilidade do Portal da Transparência e ferramenta de pesquisa.
        ◦ Responsável: Departamento de TI
        ◦ Produtos:
            ▪ Verificação da visibilidade do Portal da Transparência na página principal do site.
            ▪ Ajuste no site e no portal para inserção de ferramenta de busca otimizada.
    • Atividade: Divulgar as informações institucionais: estrutura organizacional, competências, responsáveis, endereços e horários de atendimento.
        ◦ Responsável: Departamento Administrativo e Secretaria Geral
        ◦ Produtos:
            ▪ Página atualizada com a estrutura organizacional da Câmara.
            ▪ Disponibilização dos contatos dos responsáveis (nome, cargo, email, telefone).
            ▪ Informações sobre horários de atendimento.
    • Atividade: Padronizar a divulgação das receitas e despesas da Câmara, destacando previsão e realização.
        ◦ Responsável: Departamento de Finanças.
        ◦ Produtos:
            ▪ Publicação dos dados de receitas e despesas com detalhamento orçamentário e natureza da receita.
            ▪ Implementação de ferramentas de pesquisa por período e tipo de receita/despesa.
            ▪ Publicação de histórico de informações dos últimos 3 anos.
    • Atividade: Garantir a disponibilização de um Serviço de Informação ao Cidadão (SIC) acessível e eficiente.
        ◦ Responsável: Departamento Administrativo e Ouvidoria
        ◦ Produtos:
            ▪ Implantação do canal eletrônico para pedidos de informação (e-SIC), com formulário simples e sem exigências excessivas.
            ▪ Definição dos prazos de resposta e dos responsáveis pelo SIC.
            ▪ Divulgação do relatório anual estatístico dos pedidos de informação.
    • Atividade: Garantir acessibilidade para pessoas com deficiência no site e portal (símbolo de acessibilidade, alto contraste, texto legível e redimensionável).
        ◦ Responsável: Departamento de TI e Comunicação
        ◦ Produtos:
            ▪ Implantação do símbolo de acessibilidade.
            ▪ Implementação da opção de alto contraste e ferramenta de redimensionamento de texto.
            ▪ Teste de acessibilidade do site com ferramenta especializada.
    • Atividade: Divulgação das informações referentes ao Encarregado/Responsável pelo tratamento de dados pessoais, de acordo com a LGPD (Lei Geral de Proteção de Dados)
* Responsável: Gestor Público, Departamento Jurídico
* Produtos:
* Identificação e publicação das informações relativas ao Encarregado/Responsável pelo tratamento de dados.
        ◦ Disponibilização de um Canal de Comunicação (telefone e/ou email) com o encarregado.
        ◦ Criação e publicação da Política de Privacidade e Proteção de Dados.
Fase 3: Implementação das Obrigações Específicas do Poder Legislativo (Duração: 6 semanas)
    • Atividade: Divulgar a composição da Casa, com a biografia dos parlamentares.
        ◦ Responsável: Departamento de Comunicação e Secretaria Geral
        ◦ Produtos:
            ▪ Página atualizada com a lista de parlamentares e suas biografias.
            ▪ Implementação de ferramenta de busca por parlamentar.
    • Atividade: Divulgar as leis e atos infralegais (resoluções, decretos, etc.) produzidos.
        ◦ Responsável: Departamento Jurídico e Secretaria Geral.
        ◦ Produtos:
            ▪ Criação e manutenção de um repositório de leis e atos infralegais com mecanismos de busca.
            ▪ Publicação das leis e atos infralegais em formato acessível (PDF pesquisável).
    • Atividade: Divulgar projetos de leis e atos infralegais, com tramitações.
        ◦ Responsável: Departamento Legislativo e Secretaria Geral
        ◦ Produtos:
            ▪ Implementação de ferramenta que permita a consulta de projetos de leis e atos infralegais, com acesso a ementa, documentos anexos, situação atual, autor e relator.
    • Atividade: Divulgar as pautas das sessões do Plenário e das Comissões.
        ◦ Responsável: Departamento Legislativo e Secretaria Geral
        ◦ Produtos:
            ▪ Publicação de pautas das sessões plenárias em local de fácil acesso, com detalhes sobre as matérias.
            ▪ Publicação de pautas das Comissões e seus membros.
    • Atividade: Divulgar as atas das sessões e a lista de presença dos parlamentares.
        ◦ Responsável: Departamento Legislativo e Secretaria Geral
        ◦ Produtos:
            ▪ Publicação das atas das sessões plenárias e das comissões em local de fácil acesso.
            ▪ Disponibilização de lista de presença dos parlamentares.
    • Atividade: Divulgar a lista sobre as votações nominais
* Responsável: Departamento Legislativo e Secretaria Geral
* Produtos:
        ◦ Publicação da lista sobre as votações nominais, quando houver.
    • Atividade: Publicar o ato que aprecia as Contas do Chefe do Poder Executivo e o teor do julgamento (Ata ou Resumo da Sessão que aprovou ou rejeitou as contas).
        ◦ Responsável: Departamento Legislativo e Secretaria Geral
        ◦ Produtos:
            ▪ Publicação dos atos que apreciam as contas e seus pareceres.
            ▪ Disponibilização do inteiro teor da ata ou resumo da sessão.
    • Atividade: Promover a transmissão de sessões, audiências públicas, consultas populares via meios de comunicação.
        ◦ Responsável: Departamento de Comunicação e TI
        ◦ Produtos:
            ▪ Divulgação dos canais de comunicação utilizados para a transmissão das atividades.
            ▪ Disponibilização de links ou gravações das transmissões.
    • Atividade: Divulgar a regulamentação e os valores relativos às cotas para exercício da atividade parlamentar/verba indenizatória.
        ◦ Responsável: Departamento Administrativo e Secretaria Geral.
        ◦ Produtos:
            ▪ Publicação da legislação sobre as cotas e valores.
            ▪ Publicação de informações relativas ao uso das cotas por parlamentar.
    • Atividade: Divulgar dados sobre as atividades legislativas dos parlamentares.
        ◦ Responsável: Departamento de Comunicação e Secretaria Geral
        ◦ Produtos:
            ▪ Implementação de ferramenta para consulta sobre as atividades legislativas dos parlamentares, indicando relatorias, participação em comissões, autorias etc.
    • Atividade: Incluir botão do Radar da Transparência Pública no site institucional.
        ◦ Responsável: Departamento de TI
        ◦ Produtos:
            ▪ Inserção no site do botão com link para o Radar da Transparência Pública.
Fase 4: Monitoramento, Avaliação e Melhoria Contínua (Contínuo)
    • Atividade: Monitoramento constante da conformidade com a Cartilha do PNTP e o cronograma.
        ◦ Responsável: Gestor Público
        ◦ Produtos:
            ▪ Relatórios periódicos de acompanhamento da implementação.
            ▪ Ajustes no plano de ação, quando necessários.
    • Atividade: Avaliação periódica do nível de transparência do portal da Câmara, considerando a Matriz de Critérios do PNTP.
        ◦ Responsável: Controladoria Interna e Departamentos
        ◦ Produtos:
            ▪ Relatório de avaliação, com identificação de pontos fortes e fracos.
            ▪ Propostas de melhoria para o portal da Câmara.
    • Atividade: Busca constante por novas tecnologias e soluções para aprimorar a transparência, em consonância com os objetivos do PNTP.
        ◦ Responsável: Gestor Público e Departamento de TI.
        ◦ Produtos:
            ▪ Relatório de novas ferramentas de tecnologia que possam auxiliar na transparência do poder legislativo.
Considerações Finais:
Este plano de ação será um guia para a Câmara Municipal de Jataí alcançar os mais altos padrões de transparência, garantindo o controle social e a confiança da sociedade. O compromisso de todos os envolvidos, a análise contínua e a busca por melhoria contínua são essenciais para o sucesso desta iniciativa.

Seções e Subseções da Cartilha (Acesso à Informação na Prática):
...
17.2. Demonstra detalhadamente a execução orçamentária e financeira oriundas de transferências disciplinadas pela EC n° 105 nos demonstrativos fiscais?
    3. Saúde
...
18.3. Divulga lista dos medicamentos a serem fornecidos pelo SUS e informações de como obter medicamentos, incluindo os de alto custo?
    4. Educação
...
MATRIZ ESPECÍFICA: PODER LEGISLATIVO
    1. Atividades Finalísticas – Poder Legislativo
